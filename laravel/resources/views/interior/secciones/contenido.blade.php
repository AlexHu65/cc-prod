        ...
        <div class="formulario">
          ...
          <form id="frm-comentario" class="bv-form" method="post" action="{{route('send.comentario')}}">
            ...
            <div class="form-group">
              <textarea class="form-control validate[required, minSize[10]]" name="txtComentario" id="txtComentario" placeholder="Tu comentario(*)" data-bv-field="comentario"></textarea>
            </div>
            <div class="form-group">
